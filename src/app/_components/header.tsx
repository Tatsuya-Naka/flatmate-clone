    ...
    return (
        <HydrateClient>
            <div className="relative z-[200] font-sans">
                <div className="bg-white fixed top-0 right-0 left-0 flex items-center justify-center border-b-[1px] border-solid border-gray-200 flex items-center justify-center w-full md:pt-[22px] md:pb-[21px] md:px-4 px-4 pb-4">
